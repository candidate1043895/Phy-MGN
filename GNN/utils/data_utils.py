...
def quads_to_edges(quad_cells):
    """
    Converts a list of quads to edges.
    For every square (u, v, w, x), we add edges (u, v), (v,  w), (w, x), (x, u).
...
def cubes_to_edges(cube_cells):
    """
    Converts a list of quads to edges.
    For every square ( u, v, w, x, i, j, k, m), 
    we add edges 
    (u, v), (v, w), (w, x), (x, u)
    (i, j), (j, k), (k, m), (m, i)
    (i, j), (j, k), (k, m), (m, i)
