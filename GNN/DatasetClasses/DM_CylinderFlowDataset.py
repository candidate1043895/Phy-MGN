...
class DM_CylinderFlowDataset(MGNDataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._processed_dir = osp.join(self._processed_dir, self.processed_subdir, self.output_type)
    ...
    def process(self):
        ...
        if osp.exists(self.processed_dir) and not self.force_preprocess:
            ...
            for fname in processed_file_names:
                ...
                ) #data_sample["velocity"].shape[0] --- total timesteps, same result if use data_sample["pressure"]
